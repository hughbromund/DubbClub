...
import classes from "./NBAExpandedGameInfo.module.css";
...
export default class NBAExpandedGameInfo extends Component {
  constructor(props) {
    super(props);
    // console.log(props);
...
NBAExpandedGameInfo.contextType = AuthContext;
