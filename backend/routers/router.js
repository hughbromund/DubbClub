...
router.post(
  "/api/auth/signup",
  signupDuplicates.checkDuplicateUser,
...
router.post(
  ...
  authJWT.verifyToken,
  userController.changeNotifications
);
router.post(
...
router.get(
  ...
  nbaController.getRecentGamesByTeam
);

//get game details by gameId
router.get(
  "/api/nba/getGameDetailsByGameId/:gameId",
  nbaController.getGameDetailsByGameId
);

//get game details by gameId
router.get(
  "/api/nba/updateDbWithPredictions",
  mustafarController.updateDbWithPredictions
);
...
router.get(
  ...
  authJWT.verifyTokenOptional,
  nbaController.getUpcomingGamesFromDb
);
...
router.get(
  ...
  authJWT.verifyTokenOptional,
  nbaController.getUpcomingGameIdsFromDb
);
...
router.get(
  ...
  authJWT.verifyTokenOptional,
  nbaController.getHighVoteGames
);
...
router.get(
  ...
  authJWT.verifyTokenOptional,
  nbaController.getHighPredictDiffGames
);
