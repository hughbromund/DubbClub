...
const EPLteamSchema = new Schema({
    ...
    elo: {type: Number, unique: false, required: true, default: 1500},
    position: {type: Number, unique: false, required: false, default: 0},
    lastGameID: {type: Number, unique: false, required: false},
